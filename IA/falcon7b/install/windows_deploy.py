...
model = AutoModelForCausalLM.from_pretrained(hf_model, return_dict=True, trust_remote_code=True, torch_dtype=torch.bfloat16, device_map="auto",) # gpu torch_dtype=torch.bfloat16, device_map="auto",
